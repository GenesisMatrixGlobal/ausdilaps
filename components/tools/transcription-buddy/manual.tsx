...
// Transcription Buddy, Manual tab — an inspector's dictation, read from Box, the transcript out,
// one Copy. The Daily runs tab (daily-runs.tsx) feeds the SAME pipeline from the nightly crawl.
//
...
export function ManualTranscription() {
