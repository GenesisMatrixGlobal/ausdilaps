...
import { tallyVerdicts } from "@/lib/storeys/street-view-storeys";
...
// Two agreeing angles, one confident → clear.
let t = tallyVerdicts([v(2, 60), v(2, 80)], 4);
eq([t.clear, t.storeys, t.confidence], [true, 2, 70], "two agreeing angles with one confident clear");
...
// Three facade-visible agreeing angles at 60 clear with none confident.
...
t = tallyVerdicts([v(1, 60), v(1, 62)], 5);
eq(t.clear, false, "two agreeing angles still need a confident one");
...
t = tallyVerdicts([v(1, 72), v(1, 40)], 2);
eq([t.clear, t.reason], [false, "agreeing angles, not confident enough"], "two agreeing angles averaging under 60 don't clear");
